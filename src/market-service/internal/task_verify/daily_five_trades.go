...
type DailyFiveTradesTaskVerifier struct {
	BasicTaskVerifier
}

func (verifier *DailyFiveTradesTaskVerifier) Verify(ctx common.Ctx) (bool, error) {
	...
	orders, err := verifier.AssetHandler.GetOrders(ctx, &assetBiz.OrderQuery{
